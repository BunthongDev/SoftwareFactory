            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('testimonial.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                                @csrf
                                
                                <div class="col-md-6">
                                    <label for="name" class="form-label">Client Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter client's name. e.g., (Rorn Bunthong)" required>
                                </div>

                                <div class="col-md-6">
                                    <label for="role" class="form-label">Client Role / Company</label>
                                    <input type="text" name="role" class="form-control" placeholder="e.g., CEO of Poipet Insider">
                                </div>

                                <div class="col-md-12">
                                    <label for="quote" class="form-label">Quote</label>
                                    <textarea name="quote" class="form-control" rows="4" placeholder="Enter the testimonial quote"></textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center" style="width: 100px; height: 100px; border: 1px dashed #ced4da; border-radius: 0.25rem;">
                                        <img id="avatar_preview" src="{{ url('upload/no_image.jpg') }}" alt="Avatar Preview" style="max-width: 100%; max-height: 100px;">
                                    </div>
                                </div>
