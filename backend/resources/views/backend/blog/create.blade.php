        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('blog.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                {{-- The id of this textarea matches the selector in the script below --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center justify-content-center" style="width: 100px; height: 100px; border: 1px dashed #ced4da; border-radius: 50%;">
                                    <img id="avatar_preview" src="{{ url('upload/no_image.jpg') }}" alt="Avatar Preview" style="max-width: 100%; max-height: 100px; border-radius: 50%;">
                                </div>
                            </div>
