                    ...
                    <div id="sidebar-menu">
                        ...
                        <div class="logo-box">
                            <a href="index.html" class="logo logo-light ">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('backend/assets/images/logo-dark-mode.png') }}" alt="logo" height="50">
                                </span>
                            </a>
                            <a href="index.html" class="logo logo-dark ">
                                <span class="logo-sm>
                                    <img src="{{ asset('backend/assets/images/logo-sm-light-mode.png') }}" alt="logo" height="50">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('backend/assets/images/logo-light-mode.png') }}" alt="logo" height="50">
                                </span>
                            </a>
                        </div>
