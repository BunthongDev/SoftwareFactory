                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="align-items-center">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ (!empty($profileData->image)) ? url ('upload/user_images/'.$profileData->image) : url('upload/user_images/no_image.jpg') }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
...
<form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-lg-12 col-xl-12">
                <input class="form-control" type="file" name="image" id="image" value="{{ $profileData->image }}">
            </div>
        </div>
        ...
        <div class="form-group mb-3 row">
            <div class="col-lg-12 col-xl-12">
                 <img id="ShowImage" src="{{ (!empty($profileData->image)) ? url ('upload/user_images/'.$profileData->image) : url('upload/user_images/no_image.jpg') }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
            ...
            <div class="card-body mb-0">
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        @enderror" name="old_password" type="password" placeholder="Old Password" id="old_password">
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        @enderror" name="new_password" type="password" placeholder="New Password" id="new_password">
